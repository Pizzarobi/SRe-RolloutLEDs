// Schanzer Unterboden Beleuchtung
...
#define LED_COUNT 84 // Jeweils 42 pro pin
...
uint8_t       patternChangeWanted = 0;  // 1 = Yes; 0 = No
...
void loop() {
  ...
  if((currentMillis - patternPrevious) >= patternInterval || patternChangeWanted) {  //  Check for expired time or new pattern wanted
